/*!
 * digitalgeekz: Front-end site library
 * @license MIT
 * Inline scripts may access the api using an async handler:
 *   var digitalgeekz = digitalgeekz || [];
 *   digitalgeekz.push(readyFunction);
 */
! function (t) {
    var e = {};
    ...
    d.config.hideBackface = !1, d.config.keepInherited = !0, r.define = function (t, e, n) {
        ...
        var e = window.__wf_design,
            n = void 0 !== e;
        return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug : "editor" === t ? window.digitalgeekzEditor : "test" === t ? window.__wf_test : "frame" === t ? window !== window.top : void 0 : n
    };
    ...
    var b, w = "resize.digitalgeekz orientationchange.digitalgeekz load.digitalgeekz";
    ...
    r.resize = T(c, w), r.scroll = T(c, "scroll.digitalgeekz resize.digitalgeekz orientationchange.digitalgeekz load.digitalgeekz"), r.redraw = T(), r.location = function (t) {
        window.location = t
    ...
    }, u(r.ready), A(), t.exports = window.digitalgeekz = r
}, function (t, e, n) {
    "use strict";
    var r = n(14);
    ...
    r.define("brand", t.exports = function (t) {
        ...
        return n.ready = function () {
            ...
            /\.digitalgeekz\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('<a class="w-digitalgeekz-badge"></a>').attr("href", "https://digitalgeekz.com?utm_campaign=brandjs"), r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/digitalgeekz-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/digitalgeekz-badge-text.6faa6a38cd.svg").attr("alt", "Made in digitalgeekz"), n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i).off(l, f).on(l, f))
        }, n
    })
}, function (t, e, n) {
    "use strict";
    var r = window.$,
        i = n(65) && r.tram;
    /*!
     * digitalgeekz._ (aka) Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
    ...
    r.define("edit", t.exports = function (t, e, n) {
        ...
        var i, o = t(window),
            ...
            c = "hashchange",
            s = n.load || function () {
                i = !0, window.digitalgeekzEditor = !0, o.off(c, f),
                    function (t) {
                        var e = window.document.createElement("iframe");
                        e.src = "https://digitalgeekz.com/site/third-party-cookie-check.html", e.style.display = "none", e.sandbox = "allow-scripts allow-same-origin";
                        var n = function n(r) {
                        ...
                        t.ajax({
                            url: g("https://editor-api.digitalgeekz.com/api/editor/view"),
                            data: {
            ...
            l = !1;
        try {
            l = localStorage && localStorage.getItem && localStorage.getItem("digitalgeekzEditor")
        } catch (t) { }
        ...
        function h(t) {
            return t.indexOf("//") >= 0 ? t : g("https://editor-api.digitalgeekz.com" + t)
        }
    ...
    e.createPluginInstance = function (t) {
        var e = window.digitalgeekz.require("lottie").createInstance(t);
    ...
    e.clearPlugin = function (t) {
        window.digitalgeekz.require("lottie").createInstance(t).stop()
    }
}, function (t, e, n) {
    "use strict";
    var r, i, o, a = n(0),
    ...
    i.define("forms", t.exports = function (t, e) {
        ...
        return s.ready = s.design = s.preview = function () {
            ! function () {
                o = t("html").attr("data-wf-site"), u = "https://digitalgeekz.com/api/v1/form/" + o, d && u.indexOf("https://digitalgeekz.com") >= 0 && (u = u.replace("https://digitalgeekz.com", "http://formdata.digitalgeekz.com"));
    ...
    r.define("lightbox", t.exports = function (t) {
        ...
        return i.ready = i.design = i.preview = function () {
            e = o && r.env("design"), a.destroy(), n = {}, u.find(c).digitalgeekzLightBox()
        }, jQuery.fn.extend({
            digitalgeekzLightBox: function () {
...
/**
 * ----------------------------------------------------------------------
 * digitalgeekz: Interactions 2.0: Init
 */
digitalgeekz.require('ix2').init({
    "events": {
        "e": {
            "id": "e",
            "name": "",
